...
module.exports = () => (
  <Layout>
    ...
    <div class="grid">{getGrid(12)}</div>

    <hr />
    <h2>
      Guttered grid <small>Columns with gutters</small>
    </h2>
    <div class="grid-gutters">{getGrid(12)}</div>
    <hr />
    <h2>Screen sizes</h2>
    <table>
      <thead>
    ...
    {Array.from(new Array(11)).map((i, idx) => {
      ...
      return [<h3>{i} rows</h3>, <div class="grid-gutters">{getGrid(i)}</div>];
    })}
  </Layout>
);
